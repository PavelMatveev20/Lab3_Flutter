...
final List<Services> services = <Services>[
  Services("СберПрайм","Платеж 9 июля","199 P в месяц","assets/svg/sberpraim.png"),
  Services("Переводы","Автопродление 21 августа", "199 P в месяц","assets/svg/percents_fill.png"),
];
                              ...
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Image(
                                        image: AssetImage(services[index].patch),
                                        width: 36, 
                                        height: 36,
                                      ),
